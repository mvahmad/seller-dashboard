    ...
    return(
       <>
          <div className="w-full flex justify-start p-2">
            <Link href={AppRoutes.ADD_EBOOK_PRODUCT} className="text-primary-600 hover:text-primary-800 flex items-center gap-2">
        ...
        <div className='w-full flex flex-col rounded-lg bg-white border-[1.5px] border-gray-200 my-5 gap-4'>
            ...
            <Link href={AppRoutes.ADD_EBOOK_PRODUCT_ADDITIONAL_INFO} 
