...
export default function AdditionalInfoAddProduct() {
    return(
        <>
            <div className="w-full flex justify-start p-2">
            <Link href={AppRoutes.ADD_EBOOK_PRODUCT_DETAILD_INFO} className="text-primary-600 hover:text-primary-800 flex items-center gap-2">
        ...
        <div className="w-full m-2 p-3 ">
          ...
          <div className='w-full flex flex-col rounded-lg bg-white border-[1.5px] border-gray-200 my-5 gap-4'>
            ...
            <form className="grid grid-cols-2 gap-4 p-4">
                ...
                <label htmlFor="productName" className="text-gray-700 text-sm font-semibold"> لحجه فایل صوتی </label>
                <input type="text" 
                 className="border border-gray-300 rounded-lg p-2 focus:outline-none " 
                 placeholder="لحجه فایل صوتی را وارد کنید"
                  />
                </div>


                   <div className="flex flex-col gap-4 pb-4">
                <label htmlFor="productName" className="text-gray-700 text-sm font-semibold"> لحجه فایل ویدیویی </label>
                <input type="text" 
                 className="border border-gray-300 rounded-lg p-2 focus:outline-none " 
                    placeholder="لحجه فایل ویدیویی را وارد کنید"
                  />
                </div>
            </form>

             <div className="flex justify-end p-4">
            <Link href={AppRoutes.ADD_EBOOK_PRODUCT_MEDIA}
