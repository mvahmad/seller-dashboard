...
function AddMagazineProduct() {
    return ( 
        <>
        <div className="[Add video Book Product] w-full flex justify-start p-2">
        ...
        <div className="w-full m-2 p-3 ">
            ...
            <AddProductForm href={AppRoutes.ADD_MAGAZINE_PRODUCT_DETAILD_INFO} />
    </> 

     );
}

export default AddMagazineProduct;