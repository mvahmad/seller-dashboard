...
function AddVideoProductAdditionalInfo() {
    return (
     <>
             <div className="w-full flex justify-start p-2">
            <Link href={AppRoutes.ADD_VIDEOBOOK_PRODUCT_DETAILD_INFO} className="text-primary-600 hover:text-primary-800 flex items-center gap-2">
        ...
        <div className='w-full flex flex-col rounded-lg bg-white border-[1.5px] border-gray-200 my-5 gap-4'>
            <div className="text-[#243464] p-2 font-bold">اطلاعات  محصول جدید را وارد کنید</div>
                <form className="grid grid-cols-2 gap-4 p-4">
                    ...
                    <label  className="text-gray-700 text-sm font-semibold">شماره شابک </label>
                    <input type="number"
                    ...
                    " placeholder=" شماره شابک" />
                     ...
                     <div className="flex flex-col gap-4 pb-4 ">
                <label  className="text-gray-700 text-sm font-semibold">شماره فیبا </label>
                <input type="number"
                 className="border border-gray-300 rounded-lg p-2 focus:outline-none 
                 " placeholder="شماره فیبا" />
                 </div>
                ...
                <input type="text"
                 className="border border-gray-300 rounded-lg p-2 focus:outline-none 
                 " placeholder=" لحجه فایل صوتی " />
                 </div>


                </form>
              <div className="flex justify-end p-4">
            <Link href={AppRoutes.ADD_VIDEOBOOK_PRODUCT_MEDIA} 
...
export default AddVideoProductAdditionalInfo;