...
function AddAudioBookAdditionalInfo() {
    return ( 
    <>
             <div className="w-full flex justify-start p-2">
            <Link href={AppRoutes.ADD_AUDIOBOOK_PRODUCT_DETAILD_INFO} className="text-primary-600 hover:text-primary-800 flex items-center gap-2">
...
export default AddAudioBookAdditionalInfo;